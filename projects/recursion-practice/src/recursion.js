...
//Recursive case call isEven with n - 2
return isEven(n - 2);
};
...
//Recursive case for positive n sum n-1 and the sum of integers below it
if (n > 0) {
  return (n - 1) + sumBelow(n - 1);
}

//Recursive case for negative n sum n+1 and the sum of integers below it
if (n < 0) {
  return (n + 1) + sumBelow(n + 1);
}
};
